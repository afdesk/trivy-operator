...
func TestExcludeImages(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			imageName: "gke.gcr.io/cos-nvidia-installer:fixed",
			//imageName: "cos-nvidia-installer:fixed",
			// imageName: "gke.gcr.io/nvidia-partition-gpu:1.31.0-gke.7@sha256:1f39b95124786e1786a759257a9f4d4a24c5a1688ccf54215861826b4eef7fab",
			//imageName: "gke.gcr.io/gke-metrics-collector:20250415_2300_RC0@sha256:ba0c53c89a2f6d634dd79754c29d29fe2072993eff7cb84e9a94c115197ab7fe",
			//			imageName: "gke.gcr.io/nvidia-gpu-device-plugin:1.31.0-gke.7@sha256:e27687bc1522efc8b69b1873ff5550351ef93491c63a005a06076894a2b996dd",
			want: true,
		},
		{
